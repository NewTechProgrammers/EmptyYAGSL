...
public class L0Command extends ParallelCommandGroup {
    private final Elevator elevator;
    private final InternalElevator internalElevator;
    
    public L0Command(Elevator elevator, InternalElevator internalElevator) {
        this.elevator = elevator; this.internalElevator = internalElevator;
        addCommands(new ElevatorToPositionWPILIBCommand(this.elevator, 0), new InternalElevatorToPositionCommand(this.internalElevator, 0));
    }
}
